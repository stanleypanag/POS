						...
						<div>
							...
							<small>
								<div class="input-group mb-2">
									...
									<input class="form-control form-control-sm" type="text" name="fname" placeholder="Enter First name" required>
								</div>
								<div class="input-group mb-2">
									<div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-pen-alt"></i></span></div>
									<input class="form-control form-control-sm" type="text" name="lname" placeholder="Enter Last name" required>
								</div>
								<div class="input-group mb-2">
									<div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-phone"></i></span></div>
									<input class="form-control form-control-sm" type="text" name="number" placeholder="Enter Phone number" required>
								</div>
