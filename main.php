...
?>
			...
			<body>
				<div class="h-100" style="background-color: #8D0B41;" id="container">
					<div id="header">
						<?php include('alert.php'); ?>
						<div class="d-flex justify-content-center">
							<img class="img-fluid w-50" src="images/mainLogo.png" />
						</div>
							...
							<table class="table-responsive-sm">
								<tbody>
									...
									<tr>
										...
										<td valign="baseline"><small>
												<p class="p-0 ml-5"><i class="fas fa-calendar-alt">&nbsp</i><span id='time'></span></p>
											</small></td>
									</tr>
									<tr>
										<td valign="baseline"><small class="mt-5">Customer Name:</small></td>
										<td valign="baseline"><small>
												<div class="content p-0 ml-5"><input type="text" class="form-control form-control-sm customer_search" autocomplete="off" data-provide="typeahead" id="customer_search" placeholder="Customer Search" name="customer" />
											</small>
						</div>
						</td>
				...
				<div id="content" class="mr-2">
					...
					<div id="table_buttons">
						<button id="buttons" type="button" name='enter' class="Enter btn border ml-2" style="background-color: #D6CFB4"><i class="fas fa-handshake"></i> Finish</button>
						<div class="">
							<small>
								<ul class="text-white justify-content-center">
									<li class="d-flex mb-0">Total (₱): <p id="totalValue1" class="mb-0 ml-5 pl-3">0.00</p>
									</li>
				...
				<div id="sidebar">
					...
					<div class="w-100 mt-2" id="enter_area">
						<button id="buttons" type="button" class="cancel btn border" style="background-color: #D6CFB4;"><i class="fas fa-ban"></i> Cancel</button>
					</div>
				</div>
				<div id="footer" class="w-100 d-flex justify-content-between">
					<button id="buttons" onclick="window.location.href='user/user.php'" class="btn border mr-2 ml-2 w-50" style="background-color: #D39D55"><i class="fas fa-users"></i> User</button>
					<button id="buttons" onclick="window.location.href='products/products.php'" class="btn border mr-2 w-50" style="background-color: #D39D55"><i class="fas fa-box-open"></i> Product</button>
					...
					<button id="buttons" onclick="window.location.href='customer/customer.php'" class="btn border mr-2 w-50" style="background-color: #D39D55"><i class="fas fa-user-friends"></i> Customer</button>
					<button id="buttons" onclick="window.location.href='logs/logs.php'" class="btn border mr-2 w-50" style="background-color: #D39D55"><i class="fas fa-globe"></i> Logs</button>
					...
					<button id="buttons" onclick="window.location.href='sales/sales.php'" class="btn border mr-2 w-50" style="background-color: #D39D55"><i class="fas fa-shopping-cart"></i> Sales</button>
					...
					<button id="buttons" name="logout" type="button" onclick="out();" class="logout btn btn-danger border mr-2 w-50"><i class="fas fa-sign-out-alt"></i> Logout</button>
				</div>
				</div>
				<?php include('add.php'); ?>
