				...
				<div class="h-100" style="background-color: #8D0B41;" id="container">
					<div id="header">
						...
						<div class="d-flex justify-content-center">
							<img class="img-fluid m-2 w-50" src="images/mainLogo.png" />
						</div>
					...
					<div id="content" class="mr-2">
						...
						<div id="table_buttons">
							<button style="background-color: #D39D55" id="buttons" type="button" name='enter' class="Enter btn btn-secondary border ml-2"><i class="fas fa-handshake"></i> Finish</button>
							<div class="">
								<small>
									<ul class="text-white justify-content-center">
										...
										<li class="d-flex mb-0">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<p class="dis m-0"></p>
										</li>
										<li class="d-flex">Total:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<p id="totalValue1">₱ 0.00</p>
										</li>
									</ul>
								</small>
							</div>
					...
					<div id="sidebar">
						...
						<div class="w-100 mt-2" id="enter_area">
							<button style="background-color: #AB4459;" id="buttons" type="button" class="cancel btn btn-secondary border"><i class="fas fa-ban"></i> Cancel</button>
						</div>
					</div>
					<div id="footer" class="w-100" align="center">
						<button style="background-color: #D39D55;" id="buttons" onclick="window.location.href='employee/profile.php'" class="btn btn-secondary border mr-2 ml-2"><i class="fas fa-user-circle"></i> My Profile</button>
						<button style="background-color: #D39D55;" id="buttons" onclick="window.location.href='employee/inventory.php'" class="btn btn-secondary border mr-2"><i class="fas fa-box-open"></i> Inventory</button>
						<button style="background-color: #D39D55;" id="buttons" onclick="window.location.href='employee/cashflow.php'" class="btn btn-secondary border mr-2"><i class="fas fa-money-bill-wave"></i> Cash-Flow</button>
