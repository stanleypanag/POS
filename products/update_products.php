	...
	<body>
		<div class="contain h-100">
			...
			<div class="sidebar">
				...
				<button id="sidebar_button" onclick="window.location.href='../products/addProduct.php'"><i class="fas fa-cart-plus"></i> Add Product</button>
					...
					<table class="mt-5">
						<tbody>
							...
							<tr>
								...
								<td class="pl-5 pb-2">
									<div class="input-group">
										<div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-pen-alt"></i></span></div><input type="number" name="price" step="0.01" value="<?php echo $row1['sell_price']; ?>" class="form-control form-control-sm" required>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="pl-5 pb-2">
									<div class="input-group">
										<div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-pen-alt"></i></span></div><input type="text" name="unit" value="<?php echo $row1['unit']; ?>" class="form-control-sm form-control" required>
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="pl-5 pb-2">
									<div class="input-group">
										<div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-pen-alt"></i></span></div><input type="text" name="location" value="<?php echo $row1['location']; ?>" class="form-control-sm form-control" required>
									</div>
								</td>
							</tr>
						<?php } ?>
